...
IMAGE_DIR = os.path.join(BASE_DIR, 'observations/lampadaire.jpg')
SIGMA_BLUR = 1.0
SIGMA_NOISE = SIGMA_BLUR /100
IMG_SIZE = 64
OUTPUT_DIR = os.path.join(BASE_DIR, 'resultats/lampadaire')
...
def main():
    ...
    # 1. Dégradation
    name, x0_11, y_11 = degrade_image(IMAGE_DIR, op, IMG_SIZE, OUTPUT_DIR)  
